...
{
    public class EnvironmentConfiguration : Grain<EnvironmentConfiguration.EnvironmentConfigurationState>, IEnvironmentConfiguration
    {
        ...
        public class EnvironmentConfigurationState
        {
